...
end module propagate_exception


program program_propagate_exception
  use propagate_exception
  implicit none

  call main()

end program program_propagate_exception
