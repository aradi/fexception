...
contains
  ...
  function function_propagating_error(ierror, internal_errorvar) result(res)
    ...
    try: block
      res = function_throwing_error(ierror, internal_errorvar)
  ...
  function function_throwing_error(ierror, internal_errorvar) result(res)
    integer, intent(in) :: ierror
    class(*), allocatable, intent(out) :: internal_errorvar
    integer :: res
...
end module function_exception


program program_function_exception
  use function_exception
  implicit none

  call main()

end program program_function_exception
